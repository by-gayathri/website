...
<div class="grid lg:grid-cols-3 gap-8 mb-12">
  <div class="lg:col-span-2">
    <!-- Hero Image -->
    <img src="/assets/img/api-integration.png" alt="API Integration" class="w-full rounded-lg object-cover mb-8" style="height: 300px;">
...
<?php display_reviews_section("api-integration"); ?>
